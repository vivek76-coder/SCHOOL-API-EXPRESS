...
exports.evalFinish = exports.evalStart = void 0;
exports.start = start;
exports.addReplEventForEvalReady = addReplEventForEvalReady;
...
function addReplEventForEvalReady(repl, before, after) {
    const wrapMethodWithLineByLineInputNextLine = (repl, key) => {
        if (!repl[key])
            return;
    ...
    const addNewLineOnTTYKey = [...(0, repl_paste_support_1.prototypeChain)(repl)]
        .flatMap((proto) => Object.getOwnPropertySymbols(proto))
        .find((s) => String(s).includes('(_addNewLineOnTTY)'));
