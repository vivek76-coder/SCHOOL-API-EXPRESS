...
import type { AgentWithInitialize, DevtoolsProxyOptions, RequestInit, Response } from '@mongodb-js/devtools-proxy-support';
...
export declare class CliRepl implements MongoshIOProvider {
    ...
    deviceId: Promise<string> | string | undefined;
    osInfo: Promise<OsInfo> | OsInfo | undefined;
