...
export declare function connectMongoClient(uri: string, { useSystemCA, ...clientOptions }: DevtoolsConnectOptions, logger: ConnectLogEmitter, MongoClientClass: typeof MongoClient): Promise<ConnectMongoClientResult>;
