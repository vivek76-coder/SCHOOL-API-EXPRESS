...
export declare class SnippetManager implements ShellPlugin {
    ...
    constructor({ installdir, instanceState, skipInitialIndexLoad, fetch, }: SnippetOptions);
    ...
    runNpm(npmArgs: string[], lenient?: boolean): Promise<string>;
    execFile([cmd, ...args]: string[], lenient?: boolean): Promise<string>;
