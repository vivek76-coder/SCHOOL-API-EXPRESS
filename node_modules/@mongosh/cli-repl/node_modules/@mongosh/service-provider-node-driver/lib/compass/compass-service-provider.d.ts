...
export declare class CompassServiceProvider extends NodeDriverServiceProvider {
    readonly platform: ReplPlatform;
    constructor(mongoClient: MongoClient, bus: EventEmitter, driverOptions: DevtoolsConnectOptions, uri?: ConnectionString, lastSeenTopology?: TopologyDescription);
}
