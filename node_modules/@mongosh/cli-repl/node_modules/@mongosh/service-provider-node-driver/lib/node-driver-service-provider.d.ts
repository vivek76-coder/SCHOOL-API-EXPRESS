...
export declare class NodeDriverServiceProvider extends ServiceProviderCore implements ServiceProvider {
    ...
    aggregate(database: string, collection: string, pipeline?: Document[], options?: AggregateOptions & Abortable, dbOptions?: DbOptions): AggregationCursor;
    aggregateDb(database: string, pipeline?: Document[], options?: AggregateOptions & Abortable, dbOptions?: DbOptions): AggregationCursor;
    ...
    find(database: string, collection: string, filter?: Document, options?: FindOptions & Abortable, dbOptions?: DbOptions): FindCursor;
    ...
    runCommand(database: string, spec?: Document, options?: RunCommandOptions & Abortable, dbOptions?: DbOptions): Promise<Document>;
    runCommandWithCheck(database: string, spec?: Document, options?: RunCommandOptions & Abortable, dbOptions?: DbOptions): Promise<Document>;
