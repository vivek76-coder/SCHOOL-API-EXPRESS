...
const translations = {
    ...
    'cli-repl': {
        args: {
            ...
            deepInspect: 'Force full depth inspection of server results (default: true if in interactive mode)',
                ...
                help: {
                    ...
                    attributes: {
                        ...
                        disableBlockWarnings: {
                            link: '',
                            description: 'Disables warnings for blocking operations on the cursor.',
                            example: 'db.collection.aggregate(pipeline, options).disableBlockWarnings()',
                        },
                    },
                },
            },
                ...
                help: {
                    ...
                    attributes: {
                        ...
                        getShardLocation: {
                            ...
                            description: 'Returns a document containing the shards where this collection is located as well as whether the collection itself is sharded.',
                ...
                help: {
                    ...
                    attributes: {
                        ...
                        disableBlockWarnings: {
                            link: '',
                            description: 'Disables warnings for blocking operations on the cursor.',
                            example: 'db.collection.find(query, projection, options).disableBlockWarnings()',
                        },
                    },
                },
            },
                ...
                help: {
                    ...
                    attributes: {
                        ...
                        enableMigrations: {
                            ...
                            description: 'Enables migrations for a specific collection. Uses `setAllowMigrations` admin command.',
                            example: 'sh.enableMigrations(ns)',
                        },
                        disableMigrations: {
                            link: 'https://mongodb.com/docs/manual/reference/method/sh.disableMigrations',
                            description: 'Disables migrations for a specific collection. Uses `setAllowMigrations` admin command.',
                ...
                help: {
                    ...
                    attributes: {
                        ...
                        bulkWrite: {
                            ...
                            description: 'Performs multiple write operations across databases and collections with controls for order of execution, using this session.',
                ...
                help: {
                    ...
                    attributes: {
                        ...
                        listWorkspaceDefaults: {
                            description: 'Show the default tier and maxTierSize for the stream processor workspace.',
                        },
                    },
                },
            },
