...
export type CompletionResults = [string[], string, 'exclusive'] | [string[], string];
export declare function initNewAutocompleter(instanceState: Pick<AutocompleteShellInstanceState, 'getAutocompletionContext'>): Promise<(text: string) => Promise<CompletionResults>>;
export {};
