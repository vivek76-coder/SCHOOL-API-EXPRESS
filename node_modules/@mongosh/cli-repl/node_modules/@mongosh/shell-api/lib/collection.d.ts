...
import type { FindAndModifyShellOptions, FindAndModifyMethodShellOptions, RemoveShellOptions, MapReduceShellOptions, GenericCollectionSchema, GenericDatabaseSchema, GenericServerSideSchema, StringKey, SearchIndexDefinition } from './helpers';
...
export declare class Collection<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = M[keyof M], C extends GenericCollectionSchema = D[keyof D], N extends StringKey<D> = StringKey<D>> extends ShellApiWithMongoClass {
    _mongo: Mongo<M>;
    ...
    countDocuments(query?: MQLQuery, options?: CountDocumentsOptions & Abortable): Promise<number>;
    ...
    find(query?: MQLQuery, projection?: Document, options?: FindOptions & {
        explain?: ExplainVerbosityLike;
    } & Abortable): Promise<Cursor>;
    findAndModify(options: FindAndModifyMethodShellOptions): Promise<Document | null>;
    findOne(query?: MQLQuery, projection?: Document, options?: FindOptions & Abortable): Promise<MQLDocument | null>;
