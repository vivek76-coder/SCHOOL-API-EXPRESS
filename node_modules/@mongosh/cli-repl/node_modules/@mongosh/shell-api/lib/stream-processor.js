...
let StreamProcessor = (() => {
    ...
    var StreamProcessor = _classThis = class extends _classSuper {
        ...
        async modify(pipelineOrOptions, options) {
            if (Array.isArray(pipelineOrOptions)) {
                options = { ...options, pipeline: pipelineOrOptions };
            }
            else if (typeof pipelineOrOptions === 'object') {
                if (options) {
                    throw new errors_1.MongoshInvalidInputError('If the first argument to modify is an object, the second argument should not be specified.', errors_1.CommonErrors.InvalidArgument);
                }
                options = { ...pipelineOrOptions };
            }
            else {
                throw new errors_1.MongoshInvalidInputError('The first argument to modify must be an array or object.', errors_1.CommonErrors.InvalidArgument);
            }
            return this._streams._runStreamCommand({
    ...
    (() => {
        ...
        _modify_decorators = [decorators_1.returnsPromise];
        ...
        __esDecorate(_classThis, null, _modify_decorators, { kind: "method", name: "modify", static: false, private: false, access: { has: obj => "modify" in obj, get: obj => obj.modify }, metadata: _metadata }, null, _instanceExtraInitializers);
