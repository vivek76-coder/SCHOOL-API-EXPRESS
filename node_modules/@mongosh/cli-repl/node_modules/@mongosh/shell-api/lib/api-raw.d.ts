 ...
 *
 */
declare type ClientBulkWriteModel<SchemaMap extends Record<string, Document_2> = Record<string, Document_2>> = {
...
declare class ClientBulkWriteResult_2 extends ShellApiValueClass {
    ...
    constructor({ acknowledged, insertedCount, matchedCount, modifiedCount, deletedCount, upsertedCount, insertResults, updateResults, deleteResults, }: {
        acknowledged: boolean;
        insertedCount: number;
        matchedCount: number;
        modifiedCount: number;
...
declare class ClientEncryption {
     ...
     */
    encryptExpression(expression: Document_2, options: ClientEncryptionEncryptOptions): Promise<Binary>;
    /**
...
declare class Collection<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = M[keyof M], C extends GenericCollectionSchema = D[keyof D], N extends StringKey<D> = StringKey<D>> extends ShellApiWithMongoClass {
    ...
    createIndexes(keyPatterns: Document_2[], options?: CreateIndexesOptions, commitQuorum?: number | string): Promise<string[]>;
    createIndex(keys: Document_2, options?: CreateIndexesOptions, commitQuorum?: number | string): Promise<string>;
    ensureIndex(keys: Document_2, options?: CreateIndexesOptions, commitQuorum?: number | string): Promise<Document_2>;
    getIndexes(): Promise<Document_2[]>;
    getIndexSpecs(): Promise<Document_2[]>;
    getIndices(): Promise<Document_2[]>;
    getIndexKeys(): Promise<Document_2[]>;
    dropIndexes(indexes?: string | string[] | Document_2 | Document_2[]): Promise<Document_2>;
    dropIndex(index: string | Document_2): Promise<Document_2>;
    _getSingleStorageStatValue(key: string): Promise<number>;
    totalIndexSize(...args: any[]): Promise<number>;
    reIndex(): Promise<Document_2>;
    ...
    exists(): Promise<Document_2>;
    getFullName(): string;
    getName(): N;
    runCommand(commandName: string | Document_2, options?: RunCommandOptions): Promise<Document_2>;
    ...
    stats(originalOptions?: Document_2 | number): Promise<Document_2>;
    latencyStats(options?: Document_2): Promise<Document_2[]>;
    ...
    validate(options?: boolean | Document_2): Promise<Document_2>;
    ...
    configureQueryAnalyzer(options: Document_2): Promise<Document_2>;
    checkMetadataConsistency(options?: CheckMetadataConsistencyOptions): Promise<RunCommandCursor_2>;
    getSearchIndexes(indexName?: string | Document_2, options?: Document_2): Promise<Document_2[]>;
...
export declare type CollectionWithSchema<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = M[keyof M], C extends GenericCollectionSchema = D[keyof D], N extends StringKey<D> = StringKey<D>> = Collection<M, D, C, N> & {
...
declare class Database<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = GenericDatabaseSchema> extends ShellApiWithMongoClass {
    ...
    createUser(user: Document_2, writeConcern?: WriteConcern): Promise<Document_2>;
    updateUser(username: string, userDoc: Document_2, writeConcern?: WriteConcern): Promise<Document_2>;
    changeUserPassword(username: string, password: string, writeConcern?: WriteConcern): Promise<Document_2>;
    logout(): Promise<Document_2>;
    dropUser(username: string, writeConcern?: WriteConcern): Promise<Document_2>;
    dropAllUsers(writeConcern?: WriteConcern): Promise<Document_2>;
    auth(...args: [AuthDoc] | [string, string] | [string]): Promise<{
        ok: number;
    }>;
    grantRolesToUser(username: string, roles: any[], writeConcern?: WriteConcern): Promise<Document_2>;
    revokeRolesFromUser(username: string, roles: any[], writeConcern?: WriteConcern): Promise<Document_2>;
    getUser(username: string, options?: Document_2): Promise<Document_2 | null>;
    getUsers(options?: Document_2): Promise<Document_2>;
    ...
    updateRole(rolename: string, roleDoc: Document_2, writeConcern?: WriteConcern): Promise<Document_2>;
    dropRole(rolename: string, writeConcern?: WriteConcern): Promise<Document_2>;
    dropAllRoles(writeConcern?: WriteConcern): Promise<Document_2>;
    grantRolesToRole(rolename: string, roles: any[], writeConcern?: WriteConcern): Promise<Document_2>;
    revokeRolesFromRole(rolename: string, roles: any[], writeConcern?: WriteConcern): Promise<Document_2>;
    grantPrivilegesToRole(rolename: string, privileges: any[], writeConcern?: WriteConcern): Promise<Document_2>;
    revokePrivilegesFromRole(rolename: string, privileges: any[], writeConcern?: WriteConcern): Promise<Document_2>;
    getRole(rolename: string, options?: Document_2): Promise<Document_2 | null>;
    getRoles(options?: Document_2): Promise<Document_2>;
    _getCurrentOperations(opts: Document_2 | boolean): Promise<Document_2[]>;
    currentOp(opts?: Document_2 | boolean): Promise<Document_2>;
    killOp(opId: number | string): Promise<Document_2>;
    shutdownServer(opts?: Document_2): Promise<Document_2>;
    fsyncLock(): Promise<Document_2>;
    fsyncUnlock(): Promise<Document_2>;
    version(): Promise<string>;
    serverBits(): Promise<Document_2>;
    isMaster(): Promise<Document_2>;
    hello(): Promise<Document_2>;
    serverBuildInfo(): Promise<Document_2>;
    serverStatus(opts?: {}): Promise<Document_2>;
    stats(scaleOrOptions?: number | Document_2): Promise<Document_2>;
    hostInfo(): Promise<Document_2>;
    serverCmdLineOpts(): Promise<Document_2>;
    rotateCertificates(message?: string): Promise<Document_2>;
    printCollectionStats(scale?: number): Promise<Document_2>;
    getProfilingStatus(): Promise<Document_2>;
    setProfilingLevel(level: number, opts?: number | Document_2): Promise<Document_2>;
    setLogLevel(logLevel: number, component?: Document_2 | string): Promise<Document_2>;
    getLogComponents(): Promise<Document_2>;
    cloneDatabase(): void;
    cloneCollection(): void;
    copyDatabase(): void;
    commandHelp(name: string): Promise<Document_2>;
    listCommands(): Promise<CommandResult>;
    getLastErrorObj(w?: number | string, wTimeout?: number, j?: boolean): Promise<Document_2>;
    getLastError(w?: number | string, wTimeout?: number): Promise<Document_2 | null>;
    printShardingStatus(verbose?: boolean): Promise<CommandResult>;
    printSecondaryReplicationInfo(): Promise<CommandResult>;
    getReplicationInfo(): Promise<Document_2>;
...
export declare type DatabaseWithSchema<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = GenericDatabaseSchema> = Database<M, D> & {
...
declare class KeyVault extends ShellApiWithMongoClass {
    ...
    _init(): Promise<void>;
    [asPrintable](): string;
    createKey(kms: 'local', keyAltNames?: string[]): Promise<Binary>;
    createKey(kms: ClientEncryptionDataKeyProvider, legacyMasterKey: string, keyAltNames?: string[]): Promise<Binary>;
    createKey(kms: ClientEncryptionDataKeyProvider, options: MasterKey | DataKeyEncryptionKeyOptions | undefined): Promise<Binary>;
    createKey(kms: ClientEncryptionDataKeyProvider, options: MasterKey | DataKeyEncryptionKeyOptions | undefined, keyAltNames: string[]): Promise<Binary>;
    getKey(keyId: Binary): Promise<Document_2 | null>;
    getKeyByAltName(keyAltName: string): Promise<Document_2 | null>;
    getKeys(): Promise<Cursor>;
    deleteKey(keyId: Binary): Promise<DeleteResult_2 | Document_2>;
    addKeyAlternateName(keyId: Binary, keyAltName: string): Promise<Document_2 | null>;
    removeKeyAlternateName(keyId: Binary, keyAltName: string): Promise<Document_2 | null>;
    rewrapManyDataKey(filter: Document_2, options?: Document_2): Promise<Document_2>;
...
export declare class Mongo<M extends GenericServerSideSchema = GenericServerSideSchema> extends ShellApiClass {
    ...
    getWriteConcern(): WriteConcern | undefined;
    setReadPref(mode: ReadPreferenceLike, tagSet?: Record<string, string>[], hedgeOptions?: Document_2): Promise<void>;
 ...
 */
declare type OsAdapter = Pick<typeof os, 'release' | 'platform' | 'arch' | 'type'>;
...
export declare class ReplicaSet<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = GenericDatabaseSchema> extends ShellApiWithMongoClass {
    ...
    get _mongo(): Mongo<M>;
    initiate(config?: Partial<ReplSetConfig>): Promise<Document_2>;
    _getConfig(): Promise<ReplSetConfig>;
    config(): Promise<ReplSetConfig>;
    conf(): Promise<ReplSetConfig>;
    reconfig(config: Partial<ReplSetConfig>, options?: {}): Promise<Document_2>;
    reconfigForPSASet(newMemberIndex: number, config: Partial<ReplSetConfig>, options?: {}): Promise<Document_2>;
    status(): Promise<Document_2>;
    isMaster(): Promise<Document_2>;
    hello(): Promise<Document_2>;
    printSecondaryReplicationInfo(): Promise<CommandResult>;
    printSlaveReplicationInfo(): never;
    printReplicationInfo(): Promise<CommandResult>;
    add(hostport: string | Partial<ReplSetMemberConfig>, arb?: boolean): Promise<Document_2>;
    addArb(hostname: string): Promise<Document_2>;
    remove(hostname: string): Promise<Document_2>;
    freeze(secs: number): Promise<Document_2>;
    stepDown(stepdownSecs?: number, catchUpSecs?: number): Promise<Document_2>;
    syncFrom(host: string): Promise<Document_2>;
 ...
 */
declare interface RuntimeAdapters {
    os?: OsAdapter;
}
...
export declare class Shard<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = GenericDatabaseSchema> extends ShellApiWithMongoClass {
    ...
    enableSharding(database: string, primaryShard?: string): Promise<Document_2>;
    commitReshardCollection(namespace: string): Promise<Document_2>;
    abortReshardCollection(namespace: string): Promise<Document_2>;
    shardCollection(namespace: string, key: Document_2, unique?: boolean | Document_2, options?: Document_2): Promise<Document_2>;
    reshardCollection(namespace: string, key: Document_2, unique?: boolean | Document_2, options?: Document_2): Promise<Document_2>;
    ...
    addShard(url: string): Promise<Document_2>;
    addShardToZone(shard: string, zone: string): Promise<Document_2>;
    addShardTag(shard: string, tag: string): Promise<Document_2>;
    updateZoneKeyRange(namespace: string, min: Document_2, max: Document_2, zone: string | null): Promise<Document_2>;
    addTagRange(namespace: string, min: Document_2, max: Document_2, zone: string): Promise<Document_2>;
    removeRangeFromZone(ns: string, min: Document_2, max: Document_2): Promise<Document_2>;
    removeTagRange(ns: string, min: Document_2, max: Document_2): Promise<Document_2>;
    removeShardFromZone(shard: string, zone: string): Promise<Document_2>;
    ...
    disableBalancing(ns: string): Promise<UpdateResult_2>;
    private _setAllowMigrations;
    enableMigrations(ns: string): Promise<Document_2>;
    disableMigrations(ns: string): Promise<Document_2>;
    getBalancerState(): Promise<boolean>;
    isBalancerRunning(): Promise<Document_2>;
    startBalancer(timeout?: number): Promise<Document_2>;
    stopBalancer(timeout?: number): Promise<Document_2>;
    setBalancerState(state: boolean): Promise<Document_2>;
    getShardedDataDistribution(options?: {}): Promise<AggregationCursor_2>;
    startAutoMerger(): Promise<UpdateResult_2>;
    stopAutoMerger(): Promise<UpdateResult_2>;
    isAutoMergerEnabled(): Promise<boolean>;
    disableAutoMerger(ns: string): Promise<UpdateResult_2>;
    enableAutoMerger(ns: string): Promise<UpdateResult_2>;
    checkMetadataConsistency(options?: CheckMetadataConsistencyOptions): Promise<RunCommandCursor_2>;
    shardAndDistributeCollection(ns: string, key: Document_2, unique?: boolean | Document_2, options?: Document_2): Promise<Document_2>;
    moveCollection(ns: string, toShard: string): Promise<Document_2>;
    abortMoveCollection(ns: string): Promise<Document_2>;
    unshardCollection(ns: string, toShard: string): Promise<Document_2>;
    abortUnshardCollection(ns: string): Promise<Document_2>;
    listShards(): Promise<ShardInfo[]>;
    isConfigShardEnabled(): Promise<Document_2>;
}
...
declare class StreamProcessor extends ShellApiWithMongoClass {
    ...
    get _mongo(): Mongo;
    [asPrintable](): Document_2 | undefined;
    start(options?: Document_2): Promise<Document_2>;
    stop(options?: Document_2): Promise<Document_2>;
    drop(options?: Document_2): Promise<Document_2>;
...
declare type StreamProcessorData = Document_2 & {
    name: string;
};
...
export declare class Streams<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = GenericDatabaseSchema> extends ShellApiWithMongoClass {
    ...
    listWorkspaceDefaults(): Promise<WorkspaceDefaults>;
...
declare type Topologies = (typeof ALL_TOPOLOGIES)[number];
...
declare type WorkspaceDefaults = {
