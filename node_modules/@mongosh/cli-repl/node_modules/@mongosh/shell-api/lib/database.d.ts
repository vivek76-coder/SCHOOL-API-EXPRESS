...
import type { GenericDatabaseSchema, GenericServerSideSchema, StringKey } from './helpers';
...
import type { CreateEncryptedCollectionOptions, CheckMetadataConsistencyOptions, RunCommandOptions, ExplainVerbosityLike, AggregateOptions } from '@mongosh/service-provider-core';
...
export type DatabaseWithSchema<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = GenericDatabaseSchema> = Database<M, D> & {
    [k in StringKey<D>]: Collection<M, D, D[k], k>;
};
export declare class Database<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = GenericDatabaseSchema> extends ShellApiWithMongoClass {
    _mongo: Mongo<M>;
    _name: StringKey<M>;
    ...
    _runCommand(cmd: Document, options?: CommandOperationOptions & Abortable): Promise<Document>;
    _runReadCommand(cmd: Document, options?: CommandOperationOptions & Abortable): Promise<Document>;
    _runAdminCommand(cmd: Document, options?: CommandOperationOptions & Abortable): Promise<Document>;
    _runAdminReadCommand(cmd: Document, options?: CommandOperationOptions & Abortable): Promise<Document>;
    ...
    _listCollections(filter: Document, options: ListCollectionsOptions & Abortable): Promise<Document[]>;
    _getCollectionNames(options?: ListCollectionsOptions & Abortable): Promise<string[]>;
    _getCollectionNamesWithTypes(options?: ListCollectionsOptions & Abortable): Promise<CollectionNamesWithTypes[]>;
    ...
    getCollectionInfos(filter?: Document, options?: ListCollectionsOptions & Abortable): Promise<Document[]>;
    runCommand(cmd: string | Document, options?: RunCommandOptions & Abortable): Promise<Document>;
    ...
    aggregate(pipeline: MQLPipeline, options?: AggregateOptions & Abortable): Promise<AggregationCursor>;
    ...
    sql(sqlString: string, options?: AggregateOptions): Promise<AggregationCursor>;
