...
let Collection = (() => {
    ...
    var Collection = _classThis = class extends _classSuper {
        ...
        async runCommand(commandName, options) {
            ...
            if (typeof commandName === 'string' && !(0, mongodb_redact_1.shouldRedactCommand)(commandName)) {
        ...
        async _aggregateAndScaleCollStats(collStats, scale) {
            ...
            if ((timeseriesHasStats || timeseriesBucketsNs) &&
        ...
        async _getSampleDocsForCompletion() {
            return await Promise.race([
                (async () => {
                    ...
                    this._mongo._instanceState.messageBus.emit('mongosh:load-sample-docs-complete');
                    return result;
                })(),
                (async () => {
    ...
    (() => {
        ...
        _reIndex_decorators = [decorators_1.returnsPromise, decorators_1.deprecated, (0, decorators_1.topologies)(['Standalone']), (0, decorators_1.apiVersions)([])];
        _getDB_decorators = [(0, decorators_1.returnType)('DatabaseWithSchema')];
        ...
        _getShardVersion_decorators = [decorators_1.returnsPromise, (0, decorators_1.topologies)(['Sharded']), (0, decorators_1.apiVersions)([])];
        _getShardDistribution_decorators = [decorators_1.returnsPromise, (0, decorators_1.topologies)(['Sharded']), (0, decorators_1.apiVersions)([])];
        _getShardLocation_decorators = [decorators_1.returnsPromise, (0, decorators_1.topologies)(['Sharded']), (0, decorators_1.apiVersions)([]), (0, decorators_1.serverVersions)(['8.0.10', enums_1.ServerVersions.latest])];
        ...
        _analyzeShardKey_decorators = [(0, decorators_1.serverVersions)(['7.0.0', enums_1.ServerVersions.latest]), decorators_1.returnsPromise, (0, decorators_1.topologies)(['ReplSet', 'Sharded']), (0, decorators_1.apiVersions)([])];
        _configureQueryAnalyzer_decorators = [(0, decorators_1.serverVersions)(['7.0.0', enums_1.ServerVersions.latest]), decorators_1.returnsPromise, (0, decorators_1.topologies)(['ReplSet', 'Sharded']), (0, decorators_1.apiVersions)([])];
