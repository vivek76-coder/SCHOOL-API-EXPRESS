...
export default class Shard<M extends GenericServerSideSchema = GenericServerSideSchema, D extends GenericDatabaseSchema = GenericDatabaseSchema> extends ShellApiWithMongoClass {
    ...
    splitAt(ns: string, query: MQLQuery): Promise<Document>;
    splitFind(ns: string, query: MQLQuery): Promise<Document>;
    moveChunk(ns: string, query: MQLQuery, destination: string): Promise<Document>;
