...
let ExplainableCursor = (() => {
    ...
    var ExplainableCursor = _classThis = class extends _classSuper {
        constructor(mongo, cursor, verbosity) {
            ...
            this._baseCursor = __runInitializers(this, _instanceExtraInitializers);
    ...
    (() => {
        ...
        _finish_decorators = [decorators_1.returnsPromise];
        __esDecorate(_classThis, null, _finish_decorators, { kind: "method", name: "finish", static: false, private: false, access: { has: obj => "finish" in obj, get: obj => obj.finish }, metadata: _metadata }, null, _instanceExtraInitializers);
