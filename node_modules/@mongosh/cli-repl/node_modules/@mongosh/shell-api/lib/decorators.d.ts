...
export type NewShellCommandAutocompleteParameters = Pick<AutocompletionContext, 'currentDatabaseAndConnection' | 'databasesForConnection'>;
export type ShellCommandCompleter = (params: ShellCommandAutocompleteParameters, args: string[]) => Promise<string[] | undefined>;
export type NewShellCommandCompleter = (context: NewShellCommandAutocompleteParameters, args: string[]) => Promise<string[] | undefined>;
...
export declare function shellCommandCompleter(shellCommandCompleter: ShellCommandCompleter, newShellCommandCompleter: NewShellCommandCompleter): <T extends Function>(value: T, context: ClassMethodDecoratorContext) => T & {
    shellCommandCompleter: ShellCommandCompleter;
    newShellCommandCompleter: NewShellCommandCompleter;
};
...
export declare function cursorChainable<This extends {
    _chains: any[];
}, Args extends any[], Return>(originalFunction: (this: This, ...args: Args) => Return, context: ClassMethodDecoratorContext): (this: This, ...args: Args) => Return;
